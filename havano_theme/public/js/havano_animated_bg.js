/**
 * Havano Theme - Animated Background Controller
 * Handles animated backgrounds for login and web pages
 */

class HavanoAnimatedBackground {
	constructor() {
		this.init();
		this.bindEvents();
	}
	...
	init() {
		...
		// Initialize animated background based on current page
		if (this.isLoginPage()) {
			this.initLoginBackground();
		} else {
			this.initWebBackground();
		}
	...
	addDefaultBodyClasses() {
		// Add full-width and no-breadcrumbs classes to body
		document.body.classList.add('full-width', 'no-breadcrumbs');
	}
	...
	isWebPage() {
		return document.body.classList.contains('web-page') ||
			   document.querySelector('.web-page-container') !== null ||
			   !this.isLoginPage();
	}
	...
	initWebBackground() {
		// Add web page class to body
		document.body.classList.add('web-page');

		// Create floating elements for web pages
		this.createWebFloatingElements();
	...
	createLoginBackground() {
		...
		container.innerHTML = `
			...
			<div class="animated-shape"></div>
			<div class="animated-shape"></div>
			<div class="animated-particle"></div>
			<div class="animated-particle"></div>
			<div class="animated-particle"></div>
			<div class="animated-particle"></div>
			<div class="animated-particle"></div>
	...
	createWebFloatingElements() {
		// Create floating elements container
		const container = document.createElement('div');
		container.className = 'web-floating-elements';
		...
		container.innerHTML = `
			<div class="web-animated-shape"></div>
			<div class="web-animated-shape"></div>
			<div class="web-animated-shape"></div>
			<div class="web-animated-shape"></div>
			<div class="web-animated-shape"></div>
			<div class="web-animated-particle"></div>
			<div class="web-animated-particle"></div>
			<div class="web-animated-particle"></div>
			<div class="web-animated-particle"></div>
			<div class="web-animated-particle"></div>
			<div class="web-floating-card"></div>
			<div class="web-floating-card"></div>
			<div class="web-floating-card"></div>
		`;
	...
	initFloatingElements() {
		// Add random positioning and timing to floating elements
		const shapes = document.querySelectorAll('.animated-shape, .web-floating-elements .web-animated-shape');
		...
		// Add random positioning to particles
		const particles = document.querySelectorAll('.animated-particle, .web-floating-elements .web-animated-particle');
	...
	applyThemeStyling() {
		...
		body.classList.remove('havano-theme-purple', 'havano-theme-navy', 'havano-theme-dark');

		// Apply current theme class
		if (theme) {
			body.classList.add(`havano-theme-${theme.replace(' ', '-').toLowerCase()}`);
		}
	...
	updateThemeColors(theme) {
		...
		const themeColors = {
			...
			'purple': {
				'--primary-color': '#4A2F87',
				'--secondary-color': '#3A2370',
				'--accent-color': '#2F1C5C'
			},
			'navy blue': {
	...
	pauseAnimations() {
		const animatedElements = document.querySelectorAll(
			'.animated-bg-gradient, .animated-shape, .animated-particle, .animated-wave, ' +
			'body::after, .web-floating-elements .web-animated-shape, .web-floating-elements .web-animated-particle, .web-animated-grid, .web-floating-elements .web-floating-card'
		);
	...
	changeTheme(theme) {
		localStorage.setItem('havano-theme', theme);
		this.applyThemeStyling();
	...
	// Public method to toggle animations
	toggleAnimations() {
		const animatedElements = document.querySelectorAll(
			'.animated-bg-gradient, .animated-shape, .animated-particle, .animated-wave, ' +
			'.animated-web-gradient, .web-animated-shape, .web-animated-particle, .web-animated-grid, .web-floating-card'
		);
